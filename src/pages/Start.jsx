...
function Start() {
  return (
    <>
      <h1 className={font.robotoBlack}>Lex and Yacc </h1>
      <p className={font.robotoMedium}>Made by Andrés Medinilla</p>
      <h2 className={font.robotoBlack}>What is this project about?</h2>
      ...
      <h2 className={font.robotoBlack}>How is this project structured?</h2>
      <h3 className={font.robotoBlack}>RegexEval Page</h3>
      <p className={font.robotoMedium}>
        This page is about evaluating regex and developing automathons using different algorithms
        , also simulating the automathons.
      </p>
      <h3 className={font.robotoBlack}>YalexProcessing Page</h3>
      <p className={font.robotoMedium}>
      ...
      <h3 className={font.robotoBlack}>YaparProcessing Page</h3>
      <p className={font.robotoMedium}>
      ...
      <h2 className={font.robotoBlack}>Basic Concepts</h2>
      <h3 className={font.robotoBlack}>D-Hell is lexic(al)?</h3>
      <p className={font.robotoMedium}>
      ...
      <h3 className={font.robotoBlack}>D-Hell is syntax?</h3>
      <p className={font.robotoMedium}>
      ...
      <h2 className={font.robotoBlack}>Technologies Used</h2>
      <p className={font.robotoMedium}>
